...
/// <summary>
/// Base interface for image converters.
/// This interface defines a method for converting image files.
/// Implementations of this interface should provide the actual conversion logic.
/// </summary>
public interface IImageConverter
{
    /// <summary>
    /// Converts an image file from one format to another. Saves the converted file to the specified output path.
    /// </summary>
